...
from model.mapping.admin.member import Member
...
class MemberDAO(DAO):
    ...
    def create(self, data: dict):
        try:
            member = Member(firstname=data.get('firstname'), lastname=data.get('lastname'), email=data.get('email'), password=data.get('password'))
